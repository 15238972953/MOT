...
parser.add_argument("--data-dir", default='E:\\Traffic\\Yolov5_DeepSort_Traffic-counter\\data\\dataset', type=str)   # 如果报错的话，把data路径改为绝对路径
...
def draw_curve(epoch, train_loss, train_err, test_loss, test_err):
    ...
    if epoch == 0:
        ax0.legend()
        ax1.legend()
    fig.savefig(r"deep_sort_pytorch\deep_sort\deep\train.jpg")
...
def main():
    for epoch in range(start_epoch, start_epoch+480):      # 40：表示训练40轮
